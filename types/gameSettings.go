...
type GameSettings struct {
	...
	Cardback                *string     `bson:"cardback"                json:"customCardback"`
	CardbackSaveTime        string      `bson:"cardbackSaveTime"        json:"customCardbackSaveTime"`
	CardbackID              string      `bson:"cardbackID"              json:"customCardbackUid"`
